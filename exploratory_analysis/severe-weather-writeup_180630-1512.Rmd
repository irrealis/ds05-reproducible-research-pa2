...
### Initial assessment of dataset quality
...
Over 400 new event are added between about 1993 and 1995, the majority of which are retired within about one year. The number of actively-used events continues to decline for a decade before stabilizing slightly below 50 around 2005. After 2006, exactly `r counts_by_year[2007 == year, n]` are used each year.
...
These are the permitted storm data events listed in table 1, section 2.1.1 of the
[National Weather Service Instruction 10-1605](https://d396qusza40orc.cloudfront.net/repdata%2Fpeer2_doc%2Fpd01016005curr.pdf) dated August 17, 2007 (which, provided to us by our instructors, has in its publication date a hint).
